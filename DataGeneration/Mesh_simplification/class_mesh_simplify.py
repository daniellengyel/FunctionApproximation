...
from class_3d_model import a_3d_model, calculate_plane_equation_for_one_face

# Mesh simplification calss
class MeshSimplify(a_3d_model):
    def __init__(self, points, faces, boundary_edges, interior_v, threshold, simplify_ratio):
        ...
        super().__init__(points, faces, boundary_edges, interior_v)
        self.t=threshold
    ...
    def iteratively_remove_least_cost_valid_pairs(self, verbose=False):
        ...
        while (self.number_of_points-self.new_point_count)>=self.ratio*(self.number_of_points):
            ...
            if verbose and self.new_point_count%100==0:
